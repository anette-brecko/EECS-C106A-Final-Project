...
def load_xacro_robot(xacro_path, mappings) -> yourdfpy.URDF:
    ...
    try:
        urdf_model = yourdfpy.URDF.load(temp_urdf_path, filename_handler=mac_handler)
    finally:
        # 6. Cleanup
...
def mac_handler(fname):
    if fname.startswith("package://"):
        ...
        try:
            ...
            if package_name.contains("robotiq"):
                package_path = "/Users/jhaertel/code/robotiq_hande_description"
            else:
                package_path = "/Users/jhaertel/code/ur_description"
...
def load_ur7e_with_gripper() -> yourdfpy.URDF:
    planning_dir = "/Users/jhaertel/code/catchv22/src/planning"
